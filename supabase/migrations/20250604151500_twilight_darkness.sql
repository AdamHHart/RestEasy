/*
  # Add task templates and executor tasks

  1. New Tables
    - task_templates: Stores predefined task templates for executors
    - executor_tasks: Tracks assigned tasks and their status
  ...
  3. Data
    - Insert initial task templates for common executor duties
*/

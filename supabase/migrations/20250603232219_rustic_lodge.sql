/*
  # Create trigger events and activity log tables
  
  1. New Tables
    - trigger_events
      - For tracking life events that trigger executor access
      - Includes verification methods and status
    - activity_log
  ...
  2. Security
    ...
    - Set up proper CASCADE delete behavior

/*
  # Setup core tables and security

  1. New Tables
    - executors (for managing estate executors)
    - trigger_events (for managing estate execution triggers)
    - activity_log (for auditing system activities)
